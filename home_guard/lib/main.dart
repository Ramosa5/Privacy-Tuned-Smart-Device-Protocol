...
import 'services/permissions_service.dart'; // ⬅️ NEW
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Scan for nearby ESP32-based devices via Bluetooth. '
                'Communication will be secured using your custom smart-device protocol.',
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              onPressed: () {
                // TODO: integrate with BluetoothManager to scan & pair
                // e.g. BluetoothManager.instance.scanAndConnect();
